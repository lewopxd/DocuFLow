...
EXCEL_FILE_PATH = r"C:\Users\Admin\Desktop\PLAYGROUND MARCELA\F2 CURSOS CORTOS\DB_C1F2_MARCELA.xlsx"
BASE_TEMPLATE_PATH = Path(r"C:\Users\Admin\Desktop\PLAYGROUND MARCELA\F2 CURSOS CORTOS\plantillas")
...
BASE_OUTPUT_PATH = Path(r"C:\Users\Admin\Desktop\PLAYGROUND MARCELA\F2 CURSOS CORTOS\OUTPUT\CERTIFICADOS")

# Ruta de cronogramas compartidos
CRONOGRAMAS_SHARED_PATH = Path(r"C:\Users\Admin\Desktop\PLAYGROUND MARCELA\F2 CURSOS CORTOS\CRONOGRAMAS")

# Configuración de hoja Excel
EXCEL_CONFIG = {
    "sheet": "COHORTE 1",
    "table": "Tabla_1",
    "range_config": {"type": "multiple_row", "data": "80-80"}
}
