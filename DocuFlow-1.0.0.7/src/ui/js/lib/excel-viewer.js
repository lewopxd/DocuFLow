...
class ExcelViewer {
    ...
    _clearSelection() {
        ...
        const prevSelected = this.tbody.querySelector('.ev-selected');
        if (prevSelected) prevSelected.classList.remove('ev-selected');

        // Remove row highlight
        const prevActiveRow = this.tbody.querySelector('.ev-row-active');
        if (prevActiveRow) prevActiveRow.classList.remove('ev-row-active');

        // Remove row selection
        const prevRowSelected = this.tbody.querySelector('.ev-row-selected');
        if (prevRowSelected) prevRowSelected.classList.remove('ev-row-selected');

        // Remove row num highlight
        const prevRowNum = this.tbody.querySelector('.ev-row-num-active');
        if (prevRowNum) prevRowNum.classList.remove('ev-row-num-active');
    }
