 ...
 *
 * Description:
 * Módulo centralizado para almacenar todos los iconos SVG de la aplicación
 * como constantes de string para inyección dinámica.
 */
...
/**
 * @const {string}
 * Icono para cargar hojas de datos (Excel, CSV).
 * Usado en: #load-sheet-button
 */
...
/**
 * @const {string}
 * Icono para cargar plantillas (Word).
 * Usado en: #load-template-button
 */
...
/**
 * @const {string}
 * Icono para pestañas de Hojas de Cálculo (Excel, CSV).
 * Usado en: .tab-icon (Panel Izquierdo)
 */
...
/**
 * @const {string}
 * Icono para pestañas de Documentos (Word).
 * Usado en: .tab-icon (Panel Derecho)
 */
