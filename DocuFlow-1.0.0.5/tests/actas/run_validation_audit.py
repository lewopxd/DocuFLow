...
if __name__ == "__main__":
    print(f"╔══════════════════════════════════════════════════════════════╗")
    print(f"║               SCRIPT DE AUDITORÍA DE ACTAS                   ║")
    print(f"╚══════════════════════════════════════════════════════════════╝")
        ...
        for row in row_data_list:
            ...
            if not person_folder_path.exists():
                ...
                for short_name, prefix in expected_acta_prefixes.items():
                    found = any(f.startswith(prefix) for f in physical_files)
                    if found:
            ...
            # --- [ INICIO DE MODIFICACIÓN: Lógica de Conteo ] ---
            ...
            # --- [ INICIO DE MODIFICACIÓN: Escribir nuevas columnas ] ---
